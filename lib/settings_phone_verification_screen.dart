...
class SettingsPhoneVerificationScreen extends ConsumerStatefulWidget {
  final String verificationId;
  const SettingsPhoneVerificationScreen({
    Key? key,
    required this.verificationId,
  }) : super(key: key);

  @override
  ConsumerState<SettingsPhoneVerificationScreen> createState() =>
      _SettingsPhoneVerificationScreenState();
}

class _SettingsPhoneVerificationScreenState
    extends ConsumerState<SettingsPhoneVerificationScreen> {
